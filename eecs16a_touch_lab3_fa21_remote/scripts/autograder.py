...
q_exp = {"c_pixel_no_touch" : "Plugging in the values for dimensions (L, d, and t) as well as the given epsilon and kappa (k) values into the equation for capacitance should yield the correct answer.",
        ...
        "v_x" : "We can select a good reference v_x value by choosing something in between v_no_touch and v_w_touch. To best protect us from noise, a good option would be to choose the arithmetic mean of v_no_touch and v_w_touch, i.e., (v_no_touch + v_w_touch)/2."}
